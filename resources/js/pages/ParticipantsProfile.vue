              ...
              <v-card-text>
                <v-container dense>
                  ...
                  <v-row class="mt-0">
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        :readonly="detailsReadonly"
                        :rules="[rules.required]"
                        v-model="editedItem.participant_location"
                        label="Location *"
                        dense
                      ></v-text-field>
                    </v-col>
                  ...
                  <v-row class="mt-0">
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        :readonly="detailsReadonly"
                        :rules="[rules.required]"
                        v-model="editedItem.participant_address"
                        label="Address *"
                        dense
                      ></v-text-field>
                    </v-col>
                  ...
                  <v-row class="mt-0">
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        :readonly="detailsReadonly"
                        :rules="[rules.required]"
                        v-model="editedItem.participant_position"
                        label="Position *"
                        dense
                      ></v-text-field>
                    </v-col>
                  ...
                  <v-row class="mt-0">
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.participant_age"
                        :readonly="detailsReadonly"
                  ...
                  <v-row class="mt-0">
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        :readonly="detailsReadonly"
                        :rules="[rules.required]"
                        v-model="editedItem.participant_skills"
                        label="Skills *"
                        dense
                      ></v-text-field>
                    </v-col>
                  ...
                  <v-row class="mt-0">
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        :readonly="detailsReadonly"
                        :rules="[rules.required]"
                        v-model="editedItem.name_of_training"
                  ...
                  <v-row class="mt-0">
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        :readonly="detailsReadonly"
                        :rules="[rules.required]"
                        v-model="editedItem.training_organizer"
        ...
        <v-row no-gutters style="flex-wrap: nowrap">
          ...
          >
            <v-select
              ...
              :items="
                filters.filter_items['participant_gender'].multiple_selection
              "
          ...
          >
            <div
              v-if="
                filters.filter_items['participant_age_selection'].value !=
                'range'
              "
            >
              <v-text-field
          ...
          >
            <v-select
              ...
              :items="
                filters.filter_items['participant_age_selection']
                  .multiple_selection
              "
