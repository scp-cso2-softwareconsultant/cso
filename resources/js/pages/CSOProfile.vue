    ...
    <v-app>
        ...
        <v-card>
            <v-data-table
                ...
                :search="
                    filters.filter_items[filters.filter_items_active].value
                "
                  ...
                  "
                                >
                                    ...
                                    <span class="text-h5" v-else
                                        >CSO Profile Details</span
                                    >
                                </v-card-title>
                                <v-card-text>
                                    <v-container>
                                        <button @click="loggger()">BNN</button>
                                        <h5
                                        ...
                                        <v-row
                                            class="mt-0"
                                            v-if="detailsReadonly || isEditting"
                                        >
                                        ...
                                        <v-row class="mt-0">
                                            <v-col cols="12" sm="12" md="12">
                                                <v-text-field
                                                    :readonly="detailsReadonly"
                                                    v-model="
                                                        editedItem.cso_sec_registration_no
                                                    "
                        ...
                        <v-textarea
                          ...
                          label="Core Service and Programs (i.e. policy advocacy, training, research)"
                          dense
                        >
                        </v-textarea>
                      </v-col> -->
                                                <v-combobox
                                                    ...
                                                    :rules="[rules.required]"
                                                    v-model="
                                                        editedItem.cso_core_service
                                                    "
                                                    :items="core_services"
                                                    :search-input.sync="search"
                                                    hide-selected
                                                    label="Core Service and Programs (i.e. policy advocacy, training, research)"
                                                    hint="Hit backspace to delete selected Core Service and Programs"
                                                    multiple
                                                    persistent-hint
                                                    small-chips
                                                >
                                        ...
                                        <v-row class="mt-0">
                                            ...
                                            <v-col cols="12" sm="12" md="12">
                                                <v-combobox
                                                    ...
                                                    :rules="[rules.required]"
                                                    v-model="
                                                        editedItem.cso_thematic_areas
                                                    "
                                                    :items="thematic_areas"
                                                    :search-input.sync="search"
                                                    hide-selected
                                                    label="Thematic Areas of Work (i.e. climate, gender, housing, etc.)"
                                                    hint="Hit backspace to delete selected Thematic Areas of Work"
                                                    multiple
                                                    persistent-hint
                                                    small-chips
                                                >
                                        ...
                                        <v-row class="mt-0">
                                            <v-col cols="12" sm="12" md="12">
                                                <v-text-field
                                                    :readonly="detailsReadonly"
                                                    v-model="
                                                        editedItem.cso_membership_non_government
                                                    "
                                                    label="Membership in Networks, Alliances, Consortia (Non-Government)"
                                                    dense
                                                >
                                                </v-text-field>
                                            </v-col>
                                        ...
                                        <v-row class="mt-0">
                                            <v-col cols="12" sm="12" md="12">
                                                <v-text-field
                                                    :readonly="detailsReadonly"
                                                    v-model="
                                                        editedItem.cso_membership_government
                                                    "
                                                    label=" Membership in local initiated local bodies, Technical Working Groups, etc. (Government)"
                                                    dense
                                                >
                                                </v-text-field>
                                            </v-col>
                                        ...
                                        <v-row class="mt-0">
                                            <v-col cols="12" sm="12" md="12">
                                                <v-text-field
                                                    :readonly="detailsReadonly"
                                                    v-model="
                                                        editedItem.cso_current_donors
                                                    "
                                                    label="  Current Donors (Institutional Aid Agencies, Private Sector Groups, Government)"
                                                    dense
                                                >
                                                </v-text-field>
                                            </v-col>
                                        ...
                                        <v-row class="mt-0">
                                            <v-col cols="12" sm="12" md="12">
                                                <div class="overline text-left">
                                                    <vuetify-money
                                                        v-model="
                                                            editedItem.cso_size_funding_portfolio
                                                        "
                                            ...
                                            <v-col cols="12" sm="12" md="12">
                                                <div class="overline text-left">
                                                    <v-text-field
                                                        ...
                                                        :rules="[rules.number]"
                                                        v-model="
                                                            editedItem.cso_number_networ_members
                                                        "
                                                        label=" Number of Network Members (if applicable)"
                                                        dense
                                                    >
                                                    </v-text-field>
                                                </div>
...
export default {
    ...
    methods: {
        loggger() {
            console.log(this.editedItem.cso_thematic_areas);
        },
        toMultiple() {},
        initialize() {
            ...
            axios.get("/getDistinctThematicAreas").then(response => {
                this.thematic_areas = response.data;
            });
            axios.get("/getDistinctCoreServices").then(response => {
                this.core_services = response.data;
            });
            axios.get("/cso-profile").then(response => {
                ...
                toParse.forEach(i => {
                    ...
                    var parsed3 = i.cso_thematic_areas.split("^^");
                    var parsed4 = i.cso_core_service.split("^^");
                    ...
                    i.cso_thematic_areas = constructed3;
                    i.cso_core_service = constructed4;
                });
        ...
        changeFilterActiveValue(key) {
            ...
            this.filters.filter_items_active = this.$MultiFilters.changeFilterActiveValue(
                key,
                filter,
                active_key,
                active_value
        ...
        async save() {
            ...
            if (this.isEditting) {
                ...
                if (
                    check &&
                    this.editedItemCopy.cso_id != this.editedItem.cso_id
                ) {
                    validate = false;
            ...
            if (validate) {
                ...
                if (
                    typeof editedITEM.cso_stakeholders === "object" &&
                    editedITEM.cso_stakeholders.length > 0
                )
                ...
                if (
                    typeof editedITEM.cso_registration === "object" &&
                    editedITEM.cso_registration.length > 0
                )
                    editedITEM.cso_registration.forEach(registration => {
                        if (typeof registration === "object")
                            t2 += "^^" + registration.text;
                        else t2 += "^^" + registration;
                    });
                editedITEM.cso_iterable_thematic_area = [];
                editedITEM.cso_iterable_core_services = [];

                if (this.editedItem.cso_thematic_areas) {
                    this.editedItem.cso_thematic_areas.forEach((i, idx) => {
                        if (
                            Object.prototype.toString.call(i) ===
                            "[object Object]"
                        ) {
                            editedITEM.cso_iterable_thematic_area.push(i.value);
                            t3 += "^^" + i.value;
                        } else {
                            editedITEM.cso_iterable_thematic_area.push(i);
                            t3 += "^^" + i;
                        }
                    });
                    editedITEM.cso_thematic_areas = t3.substring(2);
                }

                if (this.editedItem.cso_core_service) {
                    this.editedItem.cso_core_service.forEach((i, idx) => {
                        if (
                            Object.prototype.toString.call(i) ===
                            "[object Object]"
                        ) {
                            editedITEM.cso_iterable_core_services.push(i.value);
                            t4 += "^^" + i.value;
                        } else {
                            editedITEM.cso_iterable_core_services.push(i);
                            t4 += "^^" + i;
                        }
                    });
                    editedITEM.cso_core_service = t4.substring(2);
                }
