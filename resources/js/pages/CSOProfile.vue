                  ...
                  <v-container>
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="detailsReadonly"
                          v-model="editedItem.cso_sec_registration_no"
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="detailsReadonly"
                          v-model="editedItem.cso_membership_non_government"
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="detailsReadonly"
                          v-model="editedItem.cso_membership_government"
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="detailsReadonly"
                          v-model="editedItem.cso_current_donors"
                      ...
                      <v-col cols="12" sm="12" md="12">
                        <div class="overline text-left">
                          <v-text-field
                            :readonly="detailsReadonly"
                            :rules="[rules.number]"
                            v-model="editedItem.cso_number_networ_members"
