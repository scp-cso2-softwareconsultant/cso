      ...
      <template v-slot:top>
                  ...
                  <v-row class="mt-0">
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        ...
                        v-model="editedItem.number_of_participants"
                  ...
                  <v-row class="mt-0">
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        :readonly="detailsReadonly"
                        :rules="[rules.required]"
                        v-model="editedItem.developed_by"
                        label="Developed By *"
                        dense
                      ></v-text-field>
                    </v-col>
        ...
        <v-row no-gutters style="flex-wrap: nowrap">
          ...
          >
            <div
              v-if="
                filters.filter_items['number_of_participants_selection']
                  .value != 'range'
              "
            >
              <v-text-field
            ...
            <div v-else>
              <v-text-field
                v-model="
                  filters.filter_items['number_of_participants_min'].value
                "
              ...
              <v-text-field
                v-model="
                  filters.filter_items['number_of_participants_max'].value
                "
          ...
          >
            <v-select
              v-model="
                filters.filter_items['number_of_participants_selection'].value
              "
              :label="
                filters.filter_items['number_of_participants_selection'].text
              "
              :items="
                filters.filter_items['number_of_participants_selection']
                  .multiple_selection
              "
              @input="
                changeFilterActiveValue('number_of_participants_selection')
              "
              outlined
            ></v-select>
          </v-col>
