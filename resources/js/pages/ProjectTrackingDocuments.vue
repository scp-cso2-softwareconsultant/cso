<template>
    <v-app>
        ...
        <v-dialog v-model="dialog" max-width="500px">
            <v-sheet class="px-7 pt-7 pb-4 mx-auto text-center d-inline-block" color="brown darken-1" dark>
                <div class="grey--text text--lighten-1 text-body-2 mb-4">
                    Are you sure you want to Save this Current PTD?
                </div>
                <v-btn :disabled="loading" class="ma-1" color="cyan" plain @click="dialogOnCloseDesu">
                    Cancel
                </v-btn>
                <v-btn :loading="loading" class="ma-1" color="cyan" plain @click="save">
                    Save
                </v-btn>
            </v-sheet>
        </v-dialog>
        <v-container>
                        ...
                        <v-list-item>
                            <v-list-item-content>
                                <div class="overline text-left">
                                    Total Budget (USD) :
                                    <strong>
                                        <vue-numeric currency="$" separator="," read-only
                                            v-model="editedItem.totalBudget"></vue-numeric>
                                    </strong>
                                </div>
                                <div class="overline text-left">
                                    <vuetify-money v-model="editedItem.spent_to_date" label="Spent To Date : "
                                        v-bind:options="options" @input="setBurnRate(); update_dashboard();  " />
                                </div>
                                <div class="overline text-left">
                                    Remaining:
                                    <strong>
                                        <vue-numeric currency="$" separator="." read-only
                                            v-model="editedItem.remaining"></vue-numeric>
                                    </strong>
                                </div>
                                <div class="overline text-left">
            ...
            <v-btn v-show="crud_guard.update" class="ma-2" color="primary" block :loading="btnLoader"
