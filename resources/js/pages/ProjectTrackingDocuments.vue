        ...
        <v-row>
            <v-col cols="12" sm="6" md="6">
                <v-card class="ma-1">
                    <v-list-item  >
                        <v-list-item-content>
                            <div class="overline text-right">SOF number: </div>
                            <v-list-item-title class="headline  text-right" >60900090</v-list-item-title>
                        </v-list-item-content>
                    </v-list-item>
                </v-card>
                    <v-card class="ma-1">
                        <v-list-item  >
                            <v-list-item-content>
                                ...
                                <div class="overline text-left">Supervisor: <strong>  </strong> </div>
                                <div class="overline text-left">Sector/Thematic Area: <strong>  </strong> </div>
                                <div class="overline text-left">Program Office: <strong> CSO2 Program/Quezon City Program Office </strong> </div>
                            </v-list-item-content>
                    </v-list-item>
                </v-card>
                <v-card class="ma-1">
