        ...
        <template v-slot:top>
                  ...
                  <v-container dense>
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="detailsReadonly"
                          v-model="editedItem.finance_location"
                          label="Location"
                          dense
                        ></v-text-field>
                      </v-col>
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="detailsReadonly"
                          v-model="editedItem.finance_cost_center"
                          label="Cost Center"
                          dense
                        ></v-text-field>
                      </v-col>
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="detailsReadonly"
                          v-model="editedItem.finance_project_code"
                          label="Project Code"
                          dense
                        ></v-text-field>
                      </v-col>
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="detailsReadonly"
                          v-model="editedItem.finance_sof"
                          label="SOF"
                          dense
                        ></v-text-field>
                      </v-col>
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="detailsReadonly"
                          v-model="editedItem.finance_dea"
                          label="DEA"
                          dense
                        ></v-text-field>
                      </v-col>
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="detailsReadonly"
                          v-model="editedItem.finance_partner"
                          label="Partners Name"
                          dense
                        ></v-text-field>
                      </v-col>
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          ...
                          v-model="editedItem.finance_budget"
                          label="Budget"
                          dense
                        >
                        </v-text-field>
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="detailsReadonly"
                          :rules="[rules.number]"
                          v-model="editedItem.finance_tranche1"
                          label="1st Tranche"
                          v-on:keyup="computeBurnRate"
                          @input="tranch_date(1)"
                          dense
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          v-if="editedItem.finance_tranche1 != 0.0"
                          v-on:keyup="computeBurnRate"
                          :readonly="detailsReadonly"
                          :rules="[rules.number]"
                          v-model="editedItem.finance_tranche2"
                          @input="tranch_date(2)"
                          label="2nd Tranche"
                          dense
                        ></v-text-field>
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          v-if="editedItem.finance_tranche2 != 0.0"
                          v-on:keyup="computeBurnRate"
                          :readonly="detailsReadonly"
                          :rules="[rules.number]"
                          v-model="editedItem.finance_tranche3"
                          label="3rd Tranche"
                          @input="tranch_date(3)"
                          dense
                        ></v-text-field>
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          v-if="editedItem.finance_tranche3 != 0.0"
                          v-on:keyup="computeBurnRate"
                          :readonly="detailsReadonly"
                          :rules="[rules.number]"
                          v-model="editedItem.finance_tranche4"
                          @input="tranch_date(4)"
                          label="4th Tranche"
                          dense
                        ></v-text-field>
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="detailsReadonly"
                          :rules="[rules.number]"
                          v-model="editedItem.finance_retention"
                          label="Retention"
                          dense
                        ></v-text-field>
                      </v-col>
                    ...
                    <v-row class="mt-0" v-if="detailsReadonly">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          v-model="editedItem.finance_total"
                          label="Total"
                          dense
                          filled
                          disabled
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="detailsReadonly"
                          :rules="[rules.number]"
                          v-model="editedItem.finance_actuals"
                          label="Actuals"
                          dense
                        ></v-text-field>
                      </v-col>
                    ...
                    <v-row class="mt-0" v-if="detailsReadonly">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          v-model="editedItem.finance_variance"
                          label="Variance"
                          dense
                          filled
                          disabled
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="true"
                          :rules="[rules.number]"
                          v-model="editedItem.finance_burn1"
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="true"
                          :rules="[rules.number]"
                          v-model="editedItem.finance_burn2"
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="true"
                          :rules="[rules.number]"
                          v-model="editedItem.finance_burn3"
                    ...
                    <v-row class="mt-0">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          :readonly="true"
                          :rules="[rules.number]"
                          v-model="editedItem.finance_burn4"
                    ...
                    <v-row class="mt-0" v-if="detailsReadonly">
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field
                          v-model="editedItem.finance_burn_rate"
          ...
          <v-row no-gutters style="flex-wrap: nowrap">
            ...
            >
              <div
                v-if="
                  filters.filter_items['finance_budget_selection'].value !=
                  'range'
                "
              >
                <v-text-field
            ...
            >
              <v-select
                ...
                :items="
                  filters.filter_items['finance_budget_selection']
                    .multiple_selection
                "
          ...
          <v-row no-gutters style="flex-wrap: nowrap">
            ...
            >
              <div
                v-if="
                  filters.filter_items['finance_actuals_selection'].value !=
                  'range'
                "
              >
                <v-text-field
            ...
            >
              <v-select
                ...
                :items="
                  filters.filter_items['finance_actuals_selection']
                    .multiple_selection
                "
            ...
            >
              <div
                v-if="
                  filters.filter_items['finance_variance_selection'].value !=
                  'range'
                "
              >
                <v-text-field
            ...
            >
              <v-select
                ...
                :items="
                  filters.filter_items['finance_variance_selection']
                    .multiple_selection
                "
            ...
            >
              <div
                v-if="
                  filters.filter_items['finance_burn_rate_selection'].value !=
                  'range'
                "
              >
                <v-text-field
            ...
            >
              <v-select
                ...
                "
                :label="
                  filters.filter_items['finance_burn_rate_selection'].text
                "
                :items="
                  filters.filter_items['finance_burn_rate_selection']
                    .multiple_selection
                "
  ...
  methods: {
    ...
    detailsItem(item) {
      ...
      this.selected_finance_name = [
        { text: item.finance_name, value: item.finance_name },
      ];
      this.dialog = true;
