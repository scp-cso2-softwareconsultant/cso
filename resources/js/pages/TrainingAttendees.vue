        ...
        <v-toolbar flat>
          ...
          <v-dialog v-model="dialog" max-width="500px">
            ...
            <v-card>
              ...
              <v-card-text>
                <v-container dense>
                  ...
                  <v-row class="mt-0" v-if="detailsReadonly">
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.participant_name"
                        label="Participant Name *"
                        dense
                        readonly
                      ></v-text-field>
                  ...
                  <v-row class="mt-0" v-if="detailsReadonly">
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.project_area"
                        label="Course Name *"
                        dense
                        readonly
                      ></v-text-field>
                  ...
                  <v-row class="mt-0">
                    <v-col cols="12" sm="12" md="12">
                      <v-text-field
                        v-model="editedItem.training_mode"
              ...
              <v-card-actions class="d-flex justify-center blue-grey darken-3 white--text" v-if="!detailsReadonly">
                <v-spacer></v-spacer>
