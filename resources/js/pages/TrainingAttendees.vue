                        ...
                        <v-card>
                            ...
                            <v-card-text>
                                <v-container dense >
                                    <v-row class="mt-0" v-if="!detailsReadonly">
                                        <v-col cols="12" sm="12" md="12"  >
                                            <v-select
                                                ...
                                                v-model="editedItem.participant_id"
                                                label="Participant Name *" dense
                                    ...
                                    <v-row class="mt-0" v-if="detailsReadonly">
                                        <v-col cols="12" sm="12" md="12"  >
                                            <v-text-field v-model="editedItem.course_name"
                                                          label="Course Name *" dense readonly></v-text-field>
                                        </v-col>
                                    </v-row>

                                    <v-row class="mt-0" v-if="detailsReadonly">
                                        <v-col cols="12" sm="12" md="12"  >
                                            <v-text-field v-model="editedItem.project_area"
                                                          label="Course Name *" dense readonly></v-text-field>
                                        </v-col>
                                    </v-row>
                                    ...
                                    <v-row class="mt-0" v-if="!detailsReadonly">
                                        <v-col cols="12" sm="12" md="12" >
                                            <v-menu
                                                ref="modelDateStarted"
                                                v-model="modelDateStarted"
                                            ...
                                            >
                                                <template v-slot:activator="{ on, attrs }">
                                                    <v-text-field
                                                        v-model="editedItem.date_started"
                                                        label="Date Started *"
                                                        persistent-hint
                                    ...
                                    <v-row class="mt-0" v-if="detailsReadonly">
                                        <v-col cols="12" sm="12" md="12" >
                                            <v-text-field v-model="editedItem.date_started" label="Date Started *" dense readonly></v-text-field>
                                        </v-col>
                                    </v-row>
                                    ...
                                    <v-row class="mt-0" v-if="!detailsReadonly">
                                        <v-col cols="12" sm="12" md="12" >
                                            <v-menu
                                                ref="modelDateCompleted"
                                                v-model="modelDateCompleted"
                                                :close-on-content-click="false"
                                                transition="scale-transition"
                                                offset-y
                                                max-width="290px"
                                            ...
                                            >
                                                <template v-slot:activator="{ on, attrs }">
                                                    <v-text-field
                                                        v-model="editedItem.date_completed"
                                                ...
                                                <v-date-picker
                                                    v-model="editedItem.date_completed"
                                                    no-title
                                                    @input="modelDateCompleted = false"
                                                    dense
                                                ></v-date-picker>
                                            </v-menu>
                                        </v-col>
                                    ...
                                    <v-row class="mt-0" v-if="detailsReadonly">
                                        <v-col cols="12" sm="12" md="12" >
                                            <v-text-field v-model="editedItem.date_completed" label="Date Completed *" dense readonly></v-text-field>
                                        </v-col>
                                    </v-row>
                                    ...
                                    <v-row class="mt-0">
                                        <v-col cols="12" sm="12" md="12" >
                                            <v-text-field v-model="editedItem.training_mode"
                                                          :readonly="detailsReadonly"
                                                          :rules="[rules.required]"
                                                          label="Mode of Training *" dense></v-text-field>
                                        </v-col>
                                    </v-row>
                                    ...
                                    <v-row class="mt-0">
                                        <v-col cols="12" sm="12" md="12" >
                                            <v-text-field :readonly="detailsReadonly"
                                                          :rules="[rules.required]"
                                                          v-model="editedItem.no_hrs" label="Number of Hours *" dense></v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row class="mt-0">
                                        <v-col cols="12" sm="12" md="12" >
...
export default {
    data: vm => ({
        ...
        headers: [
            ...
            { text: 'Project Area', value: 'project_area',width: '15%',sortable: false, },
            { text: 'Date Started', value: 'date_started',width: '10%',sortable: false, },
            { text: 'Date Completed', value: 'date_completed',width: '10%',sortable: false, },
            { text: 'Mode of Training', value: 'training_mode',width: '10%',sortable: false, },
    ...
    computed: {
        formTitle () {
            return this.editedIndex === -1 ? 'New Training Attendees' : 'Edit Training Attendees'
        },
    },
    ...
    methods: {
        ...
        deleteItemConfirm () {
            ...
            axios.post('/delete-training-attendees', {
        ...
        save () {
            ...
            if(validate){
                axios.post('/save-training-attendees', {
