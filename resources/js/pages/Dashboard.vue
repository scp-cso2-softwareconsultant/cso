<template>
    <v-app>
        ...
        <div class="card p-md-5">
            ...
            <div class="card-body">
                <center>
                    <v-combobox class="d-inline-block p-3" hide-selected small-chips
                        v-on:change="updateCSOIndicatorsChart()" v-model="selectedOrganization"
                        :items="responsibleOrganization" label="Responsible Organization"></v-combobox>
                </center>
                <PieChart :D="pieData" />
            </div>
        </div>
                ...
                <v-card class="ma-1 m-3">
                    <v-row class="mt-0">
                        <v-col class='d-flex' cols="12" sm="12" md="12">
                            <v-select chips :items="financeYears" v-model="selectedFinanceYear" @change="financeTracker"
                                label="Select Year" class="m-2"></v-select>
                            <v-select chips :items="financeMonths" v-model="selectedFinanceMonth"
                                @change="financeTracker" label="Select Month" class="m-2"></v-select>
                        </v-col>
                    </v-row>
                </v-card>
                ...
                <v-card class="ma-1">
                    <v-list-item>
                        <v-list-item-content>
                            ...
                            <div class="text-center">
                                <apexchart type="bar" height="350" :options="burnRateChartOptions"
                                    :series="burnRateSeries"></apexchart>
                            </div>
                        </v-list-item-content>
                    </v-list-item>
                </v-card>
    ...
    export default {
        ...
        methods: {
            ...
            async financeTracker() {
                ...
                this.financeBarData.title.text = "Fund Received vs Actual Expenditures (" + this
                    .selectedFinanceMonth + ", " + this.selectedFinanceYear + ")";
