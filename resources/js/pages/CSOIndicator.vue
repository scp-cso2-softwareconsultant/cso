                        ...
                        <v-card>
                            ...
                            >
                                <template v-slot:top>
                                    ...
                                    >
                                            ...
                                            <v-card>
                                                ...
                                                <v-card-text>
                                                    <v-container dense>
                                                        <v-row class="mt-0" >
                                                            <v-col cols="12" sm="12" md="12" >
                                                                <v-text-field v-model="editedSubItem.indicator_no"
                                                                              :rules="[rules.required]"
                                                                              :readonly="detailsReadonly"
                                                                              label="Indicator No. *" dense ></v-text-field>
                                                            </v-col>
                                                        </v-row>
                                                        ...
                                                        <v-row class="mt-0">
                                                            <v-col cols="12" sm="12" md="12" >
                                                                <v-textarea auto-grow rows="1"
                                                                            :rules="[rules.required]"
                                                                            :readonly="detailsReadonly"
                                                                            v-model="editedSubItem.indicator" label="Indicator *" dense ></v-textarea>
                                                            </v-col>
                                                        </v-row>
                                                        ...
                                                        <v-row class="mt-0" v-if="detailsReadonly">
                                                            <v-col cols="12" sm="12" md="12" >
                                                                <v-text-field v-model="editedSubItem.indicator_type"
                                                                              label="Type *" dense readonly></v-text-field>
                                                            </v-col>
                                                        </v-row>
                                                        <v-row class="mt-0">
                                                            <v-col cols="12" sm="12" md="12" >
                                                        ...
                                                        <v-row class="mt-0" v-if="detailsReadonly">
                                                            <v-col cols="12" sm="12" md="12" >
                                                                <v-text-field v-model="editedSubItem.frequency"
                                                                              label="Frequency *" dense readonly></v-text-field>
                                                            </v-col>
                                                        </v-row>
                                                        <v-row class="mt-0">
                                                            <v-col cols="12" sm="12" md="12" >
                                                        ...
                                                        <v-row class="mt-0" v-if="detailsReadonly">
                                                            <v-col cols="12" sm="12" md="12" >
                                                                <v-text-field v-model="editedSubItem.ppr"
                                                                              label="PPR *" dense readonly></v-text-field>
                                                            </v-col>
                                                        </v-row>
                                                        <v-row class="mt-0" v-if="detailsReadonly">
                                                            <v-col cols="12" sm="12" md="12" >
                                                                <v-textarea auto-grow rows="1" v-model="editedSubItem.baseline_date" label="Baseline Date" dense readonly ></v-textarea>
                                                            </v-col>
                                                        </v-row>
                                                        <v-row class="mt-0" v-if="!detailsReadonly">
                                                            <v-col cols="12" sm="12" md="12" >
                                                        ...
                                                        <v-row class="mt-0" v-if="detailsReadonly">
                                                            <v-col cols="12" sm="12" md="12" >
                                                                <v-textarea auto-grow rows="1" v-model="editedSubItem.target_date" label="Target Date" dense readonly ></v-textarea>
                                                            </v-col>
                                                        </v-row>
                                                        <v-row class="mt-0" v-if="!detailsReadonly">
                                                            <v-col cols="12" sm="12" md="12" >
                                                        ...
                                                        <v-row class="mt-0" v-if="detailsReadonly">
                                                            <v-col cols="12" sm="12" md="12" >
                                                                <v-textarea auto-grow rows="1" v-model="editedSubItem.actual_date" label="Actual date" dense readonly></v-textarea>
                                                            </v-col>
                                                        </v-row>
                                                        <v-row class="mt-0" v-if="!detailsReadonly">
                                                            <v-col cols="12" sm="12" md="12" >
                                                        ...
                                                        <v-row class="mt-0">
                                                            <v-col cols="12" sm="12" md="12" >
                                                                ...
                                                                <!--                                            ></v-file-input>-->
                                                                <div v-if="isRemove">
                                                                    <v-btn background depressed @click="removeFile">{{ file_name }}
                                                                    </v-btn>
                                                                </div>
                                                                <div v-else>
                                        ...
                                        <v-btn color="lightgray"
                                               class="mb-2"
                                               :loading="btnLoader"
                                               @click="exportExcel('CSO2 Indicator', item.value)" >
                                            Export
                                ...
                                <template v-slot:item.cso_status="{ item }">
                                    <v-progress-linear v-if="item.cso_status != 'Entry' " height="15" :color="getColor(item.cso_status)" :value="item.cso_completion" dark>
                                        <span><strong>item.cso_count</strong></span>
                                    </v-progress-linear>
                                    <v-progress-linear v-else height="15" :color="getColor(item.cso_status)" :value="100" dark>
                                    </v-progress-linear>
                                </template>
...
export default {
    data: () => ({
        ...
        singleExpand: false,
        subHeaders:[
            { text: 'Indicator No.', value: 'indicator_no',width: '12%',sortable: false, },
            { text: 'Indicator', value: 'indicator',width: '20%',sortable: false, },
            { text: 'Type', value: 'indicator_type',width: '15%',sortable: false, },
            { text: 'Data Source', value: 'data_source',width: '20%',sortable: false, },
            { text: 'Frequency', value: 'frequency',width: '15%',sortable: false, },
            { text: 'Unit of Measure', value: 'unit_measure',width: '15%',sortable: false, },
            { text: 'PPR', value: 'ppr',width: '3%',sortable: false, },
            { text: 'Action', value: 'actions',width: '5%',align: 'center', sortable: false, },
        ],
        headers: [
            { text: 'Category', align: 'start', sortable: false, value: 'cso_category', width: '15%' },
            { text: 'Description', align: 'start', sortable: false, value: 'cso_description' },
            { text: 'Status', value: 'cso_status',width: '10%',sortable: false, },
            { text: 'Action', value: 'actions',width: '10%',align: 'right', sortable: false, },
    ...
    computed: {
        formTitle () {
            return this.editedIndex === -1 ? 'New CSO2 Indicator' : 'Edit CSO2 Indicator'
        },
    },
    ...
    methods: {
        ...
        getIndicator: function(categorySelected){
            ...
            this.loadCSOIndicator = true;
            axios.post('/cso-indicator-list', {category: categorySelected }).then( response => {
                this.indicators_list = response.data;
                this.loadCSOIndicator = false;
            })
        },
        ...
        deleteItemConfirm () {
            ...
            if(this.delete_cso){
                axios.post('/delete-cso-indicator', {
            ...
            if(this.delete_indicator){
                axios.post('/delete-cso-indicator-details', {
        ...
        getColor (status) {
            ...
            else if (status == 'Entry') return 'yellow'
